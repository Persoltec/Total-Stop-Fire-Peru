...
export const Nav10DataSource = {
  ...
  page: { className: 'home-page jqauf4uk7uk-editor_css' },
  logo: {
  ...
  Menu: {
    ...
    children: [
      { name: 'item0', a: { children: 'Inicio', href: '' } },
      { name: 'item1', a: { children: 'Nosotros', href: '' } },
      { name: 'item2', a: { children: 'Servicios', href: '' } },
      { name: 'item3', a: { children: 'Productos', href: '' } },
    ],
  },
  mobileMenu: { className: 'header1-mobile-menu' },
  help: { className: 'help', children: 'Contactenos' },
  user: {},
};
...
export const Content71DataSource = {
  ...
  page: { className: 'home-page content7 jqb0kukvu16-editor_css' },
  OverPack: {},
  titleWrapper: {
    className: 'title-wrapper',
    children: [
...
export const Content80DataSource = {
  ...
  page: { className: 'home-page content8 jqb0ixvranh-editor_css' },
  OverPack: { playScale: 0.3 },
  titleWrapper: {
    className: 'title-wrapper',
    children: [
